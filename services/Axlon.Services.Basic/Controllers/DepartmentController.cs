...
namespace Axlon.Services.Basic.Controllers
{
    ...
    public class DepartmentController : BaseApiController
    {
        ...
        [HttpGet]
        public async Task<MessageModel<PageResponseModel<Department>>> Get(int page = 1, string key = "", int intPageSize = 50)
        {
            ...
            return new MessageModel<PageResponseModel<Department>>()
            {
                msg = "获取成功",
                success = true,
